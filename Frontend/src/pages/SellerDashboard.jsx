                ...
                <main className="bg-white rounded-2xl p-8 shadow-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 border border-gray-100 rounded-xl bg-green-50">
                            <h2 className="text-lg font-semibold text-green-800 mb-2">My Inventory</h2>
                            <p className="text-green-700">List and manage your fresh produce for sale.</p>
                        </div>
                        <div className="p-6 border border-gray-100 rounded-xl bg-purple-50">
                            <h2 className="text-lg font-semibold text-purple-800 mb-2">Sales Analytics</h2>
                            <p className="text-purple-700">View your earnings and performance charts.</p>
                        </div>
                    </div>
                </main>
            </div>
