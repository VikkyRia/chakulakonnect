                    ...
                    <div className="xl:col-span-4 space-y-8">
                        ...
                        <div className="bg-slate-900 rounded-[3rem] p-10 text-white relative overflow-hidden shadow-2xl shadow-slate-200">
                            ...
                            <div className="space-y-6 relative z-10">
                                ...
                                <button
                                    onClick={() => navigate('/seller-dashboard/forecast')}
                                    className="w-full py-4 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-white text-xs font-black uppercase tracking-widest shadow-xl shadow-emerald-900/40 transition-all active:scale-95 flex items-center justify-center gap-2"
                                >
                                    View Strategy Board
